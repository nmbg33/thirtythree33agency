      ...
      <section className="pt-36 pb-24 relative">
        <div className="mx-auto w-full max-w-4xl px-4 sm:px-6">
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-4">{t("services.growth.title")}</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <h3 className="text-xl font-semibold mb-3">{t("services.growth.what")}</h3>
            ...
            >
              <h3 className="text-xl font-semibold mb-3">{t("services.growth.outcomes")}</h3>
              <ul className="space-y-2 text-gray-700">
