          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li>• React, TypeScript, accessibility</li>
                <li>• Animations and WebGL</li>
                <li>• CI/CD, testing, and monitoring</li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li>• Scalable component libraries</li>
                <li>• SEO and schema best practices</li>
